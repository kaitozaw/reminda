...
Revision ID: 17c1b90255f4
Revises: 
Create Date: 2025-07-14 22:32:50.830119
...
def upgrade():
    ...
    sa.Column('reminder_activate', sa.Boolean(), nullable=False),
    sa.Column('reminder_timezone', sa.String(length=64), nullable=True),
